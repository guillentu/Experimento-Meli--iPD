...
set(hh, "fontsize", 14);
grid on;
t=text(-0.5*[1 1 1 1 1 1]+30*_mediaXsujeto(I), .1+_alimento(I) ,_txtSujetos(I,:));
...
set(hh, "fontsize", 14);
grid on;
t=text(-0.45*[1 1 1 1 1 1]+30*_mediaXsujeto(I), 0.02*[1 1 1 1 1 1]+_delay2eat(I) ,_txtSujetos(I,:));
axis([1 ,30, 0, 1],'auto');
hold on;
