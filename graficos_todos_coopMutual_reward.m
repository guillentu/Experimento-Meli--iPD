...
fin=[18 27 18 18 27 27];
foodMax=45;
i=1;scatter(mean(foodMax*food_T3(fin(i)-9:fin(i),i)),mean(promediosC_T3(fin(i)-9:fin(i),i)),150,'g','linewidth',2)
i=3;scatter(mean(foodMax*food_T3(fin(i)-9:fin(i),i)),mean(promediosC_T3(fin(i)-9:fin(i),i)),150,'g','linewidth',2)
i=4;scatter(mean(foodMax*food_T3(fin(i)-9:fin(i),i)),mean(promediosC_T3(fin(i)-9:fin(i),i)),150,'g','linewidth',2)
