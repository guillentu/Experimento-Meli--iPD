...
% 
% plot(mean(foodMax*foodMedia_T2([1 3 7 8 9 10 11 12])),mean(mediaXsujeto_T2([1 3 7 8 9 10 11 12])),'or')
% plot(mean(foodMax*foodMedia_T2([1 3 7 8 9 10 11 12])),mean(mediaXsujeto_T2([1 3 7 8 9 10 11 12])),'ob')
...
i=a;aux1(1)=mean(promediosC_T3(1:4,i));
%i=b;aux1(2)=mean(promediosC_T3(1:4,i));
i=c;aux1(3)=mean(promediosC_T3(1:4,i));
puntosSem(1)=std(aux1)/sqrt(length(aux1));
puntos(1)=mean(aux1);
i=a;aux1(1)=mean(promediosC_T3(fin(i)-4:fin(i),i))
%i=b;aux1(2)=mean(promediosC_T3(fin(i)-4:fin(i),i))
i=c;aux1(3)=mean(promediosC_T3(fin(i)-4:fin(i),i))
puntos(2)=mean(aux1);
puntosSem(2)=std(aux1)/sqrt(length(aux1));
% % T=4
fin=[17 14 17 17 14 14];foodMax=60;
...
i=a;aux1(1)=mean(promediosC_T4(fin(i)-4:fin(i),i))
%i=b;aux1(2)=mean(promediosC_T4(fin(i)-4:fin(i),i))
i=c;aux1(3)=mean(promediosC_T4(fin(i)-4:fin(i),i))
%puntos(3)=mean(aux1);
puntos(3)=mean(aux1([1 3]));
puntosSem(3)=std(aux1)/sqrt(length(aux1));
...
% T=3
fin=[18 27 18 18 27 27];foodMax=45;
i=a;aux1(1)=mean(R2_T3(i,1:4));
%i=b;aux1(2)=mean(R2_T3(i,1:4));
i=c;aux1(3)=mean(R2_T3(i,1:4));
puntosSem(1)=std(aux1)/sqrt(length(aux1));
puntos(1)=mean(aux1);
i=a;aux1(1)=mean(R2_T3(i,fin(i)-4:fin(i)))
%i=b;aux1(2)=mean(R2_T3(i,fin(i)-4:fin(i)))
i=c;aux1(3)=mean(R2_T3(i,fin(i)-4:fin(i)))
puntos(2)=mean(aux1);
puntosSem(2)=std(aux1)/sqrt(length(aux1));
% % T=4
fin=[17 14 17 17 14 14];foodMax=60;
...
% puntos(3)=mean(aux1);
% puntosSem(3)=std(aux1)/sqrt(length(aux1));
i=a;aux1(1)=mean(R2_T4(i,fin(i)-4:fin(i)))
%i=b;aux1(2)=mean(R2_T4(i,fin(i)-4:fin(i)))
i=c;aux1(3)=mean(R2_T4(i,fin(i)-4:fin(i)))
%puntos(3)=mean(aux1);
puntos(3)=mean(aux1([1 3]));
puntosSem(3)=std(aux1)/sqrt(length(aux1));
